export const installed_blueprints = [
  //@BlueprintInsertion
{ name: 'EmailAuth100', human_name: 'Email Auth', access_route: 'EmailAuth100', icon: 'envelope-o'},
{ name: 'EmailAuth99', human_name: 'Email Auth', access_route: 'EmailAuth99', icon: 'envelope-o'},
